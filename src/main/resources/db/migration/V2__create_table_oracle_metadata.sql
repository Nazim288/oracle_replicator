CREATE TABLE IF NOT EXISTS oracle_metadata.database_metadata (
                                                                id        bigint NOT NULL,
...
CREATE INDEX database_metadata_service_name_idx ON oracle_metadata.database_metadata USING btree (service_name);

CREATE TABLE IF NOT EXISTS oracle_metadata.schema_metadata (
                                                              id        bigint NOT NULL,
...
CREATE INDEX schema_metadata_service_name_idx ON oracle_metadata.schema_metadata USING btree (service_name);

CREATE TABLE IF NOT EXISTS oracle_metadata.table_metadata (
                                                             id        bigint NOT NULL,
...
CREATE INDEX table_metadata_service_name_idx ON oracle_metadata.table_metadata USING btree (service_name);